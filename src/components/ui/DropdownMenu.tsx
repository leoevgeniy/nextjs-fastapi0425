    ...
    <AnimatePresence>
      ...
      >
        <DropdownMenuPrimitive.Content
          ...
          className={cn(
            "z-50 min-w-[8rem] overflow-hidden rounded-lg border border-gray-700 bg-gray-900 p-1 shadow-lg",
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ...
    className={cn(
      ...
      "transition-colors focus:bg-gray-800 focus:text-purple-400",
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Label
    ref={ref}
    className={cn(
      "px-3 py-2 text-xs font-medium text-gray-400",
      inset && "pl-8",
      className
    )}
    {...props}
